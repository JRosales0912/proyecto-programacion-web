        ...
        colorCell: [
            {
                ...
                selectors: (_a = {},
                    ...
                    _a["." + Utilities_1.IsFocusVisibleClassName + " &:focus, ." + Utilities_1.IsFocusVisibleClassName + " &:focus::after"] = { borderColor: 'transparent' },
                    _a["." + Utilities_1.IsFocusVisibleClassName + " &:focus $svg"] = getSvgSelectorStyles(theme.palette.neutralQuaternaryAlt, false),
