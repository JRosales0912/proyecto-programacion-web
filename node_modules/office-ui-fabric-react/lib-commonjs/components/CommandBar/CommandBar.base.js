...
var CommandBarBase = /** @class */ (function (_super) {
    ...
    function CommandBarBase() {
        ...
        _this._onRenderItem = function (item) {
            ...
            var commandButtonProps = tslib_1.__assign({ allowDisabledFocus: true }, item, { styles: tslib_1.__assign({ root: { height: '100%' }, label: { whiteSpace: 'nowrap' } }, item.buttonStyles), className: Utilities_1.css('ms-CommandBarItem-link', item.className), text: !item.iconOnly ? itemText : undefined, menuProps: item.subMenuProps, onClick: _this._onButtonClick(item) });
