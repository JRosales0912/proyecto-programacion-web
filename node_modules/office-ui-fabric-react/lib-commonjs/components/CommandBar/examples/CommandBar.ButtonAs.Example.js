...
var CommandBarButtonAsExample = /** @class */ (function (_super) {
    ...
    CommandBarButtonAsExample.prototype.render = function () {
        var customButton = function (props) {
            ...
            return (React.createElement(Button_1.CommandBarButton, tslib_1.__assign({}, props, { onClick: buttonOnMouseClick, styles: tslib_1.__assign({}, props.styles, { textContainer: { fontSize: 18 }, icon: { color: 'red' } }) })));
        };
