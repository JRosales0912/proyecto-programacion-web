define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/SearchBox", "office-ui-fabric-react/lib/Icon", "./ContextualMenuExample.scss"], function (require, exports, tslib_1, React, Button_1, SearchBox_1, Icon_1) {
    "use strict";
        ...
        ContextualMenuWithCustomMenuListExample.prototype._renderMenuList = function (menuListProps, defaultRender) {
            return (React.createElement("div", null,
                React.createElement("div", { style: { borderBottom: '1px solid #ccc' } },
                    React.createElement(SearchBox_1.SearchBox, { placeholder: "Filter actions", onAbort: this._onAbort, onChange: this._onChange, styles: {
                            root: [{ margin: '8px' }]
                        } })),
