define(["require", "exports", "tslib", "react", "./ContextualMenu.types", "../../FocusZone", "../../Utilities", "../../utilities/contextualMenu/index", "../../utilities/decorators/withResponsiveMode", "../../Callout", "./ContextualMenu", "./ContextualMenuItem", "./ContextualMenuItemWrapper/index", "../../Styling", "./ContextualMenu.classNames"], function (require, exports, tslib_1, React, ContextualMenu_types_1, FocusZone_1, Utilities_1, index_1, withResponsiveMode_1, Callout_1, ContextualMenu_1, ContextualMenuItem_1, index_2, Styling_1, ContextualMenu_classNames_1) {
    "use strict";
    ...
    var ContextualMenuBase = /** @class */ (function (_super) {
        ...
        function ContextualMenuBase(props) {
            ...
            _this._onRenderMenuList = function (menuListProps, defaultRender) {
                ...
                return (React.createElement("ul", { className: _this._classNames.list, onKeyDown: _this._onKeyDown, onKeyUp: _this._onKeyUp }, menuListProps.items.map(function (item, index) {
        ...
        ContextualMenuBase.prototype.render = function () {
            ...
            if (items && items.length > 0) {
                ...
                return (React.createElement(Callout_1.Callout, tslib_1.__assign({}, calloutProps, { target: target, isBeakVisible: isBeakVisible, beakWidth: beakWidth, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL, gapSpace: gapSpace, coverTarget: coverTarget, doNotLayer: doNotLayer, className: Utilities_1.css('ms-ContextualMenu-Callout', calloutProps ? calloutProps.className : undefined), setInitialFocus: shouldFocusOnMount, onDismiss: this.props.onDismiss, onScroll: this._onScroll, bounds: bounds, directionalHintFixed: directionalHintFixed, hidden: this.props.hidden }),
                    React.createElement("div", { role: 'menu', "aria-label": ariaLabel, "aria-labelledby": labelElementId, style: contextMenuStyle, ref: function (host) { return (_this._host = host); }, id: id, className: this._classNames.container, tabIndex: shouldFocusOnContainer ? 0 : -1, onKeyDown: this._onMenuKeyDown, onKeyUp: this._onKeyUp, onFocusCapture: this._onMenuFocusCapture },
                        title && React.createElement("div", { className: this._classNames.title },
                            " ",
                            title,
                            " "),
                        items && items.length ? (React.createElement(FocusZone_1.FocusZone, tslib_1.__assign({}, this._adjustedFocusZoneProps, { className: this._classNames.root, isCircularNavigation: true, handleTabKey: 1 /* all */ }), onRenderMenuList({
                            items: items,
        ...
        ContextualMenuBase.prototype._renderMenuItem = function (item, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
            ...
            if (getItemClassNames) {
                ...
                itemClassNames = Styling_1.mergeStyleSets(getContextualMenuItemClassNames(ContextualMenu_classNames_1.getItemClassNames, itemStyleProps), getContextualMenuItemClassNames(styles, itemStyleProps));
            }
