define(["require", "exports", "tslib", "react", "../../Utilities", "../../KeytipData"], function (require, exports, tslib_1, React, Utilities_1, KeytipData_1) {
    ...
    var LinkBase = /** @class */ (function (_super) {
        ...
        LinkBase.prototype._removeInvalidPropsForRootType = function (RootType, props) {
            // Deconstruct the props so we remove props like `as`, `theme` and `styles`
            // as those will always be removed. We also take some props that are optional
            // based on the RootType.
            var children = props.children, as = props.as, disabled = props.disabled, target = props.target, href = props.href, theme = props.theme, getStyles = props.getStyles, styles = props.styles, restProps = tslib_1.__rest(props, ["children", "as", "disabled", "target", "href", "theme", "getStyles", "styles"]);
            // RootType will be a string if we're dealing with an html component
            if (typeof RootType === 'string') {
                // Remove the disabled prop for anchor elements
                if (RootType === 'a') {
                    return tslib_1.__assign({ target: target,
                        href: href }, restProps);
                }
                // Remove the target and href props for non anchor elements
                return tslib_1.__assign({}, restProps, { disabled: disabled });
            }
