define(["require", "exports", "tslib", "react", "../../Utilities", "../../Styling", "../FocusTrapZone/index", "./Panel.types", "../../Layer", "../../Overlay", "../../Popup", "../../Button"], function (require, exports, tslib_1, React, Utilities_1, Styling_1, index_1, Panel_types_1, Layer_1, Overlay_1, Popup_1, Button_1) {
    "use strict";
    ...
    var PanelBase = /** @class */ (function (_super) {
        ...
        PanelBase.prototype.render = function () {
            ...
            return (React.createElement(Layer_1.Layer, tslib_1.__assign({}, layerProps),
                React.createElement(Popup_1.Popup, { role: "dialog", ariaLabelledBy: header ? headerTextId : undefined, onDismiss: this.dismiss, className: _classNames.hiddenPanel },
