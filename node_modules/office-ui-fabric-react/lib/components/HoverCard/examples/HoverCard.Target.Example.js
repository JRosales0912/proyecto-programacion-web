...
var HoverCardField = /** @class */ (function (_super) {
    ...
    HoverCardField.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (c) { return !_this.state.contentRendered && _this.setState({ contentRendered: c }); }, "data-is-focusable": true },
            this.props.content,
            this.state.contentRendered && (React.createElement(HoverCard, { expandingCardProps: this.props.expandingCardProps, target: this.state.contentRendered, cardDismissDelay: 300, onCardVisible: this._log('onCardVisible'), onCardHide: this._log('onCardHide'), trapFocus: true, openHotKey: 13 /* enter */ }))));
    };
