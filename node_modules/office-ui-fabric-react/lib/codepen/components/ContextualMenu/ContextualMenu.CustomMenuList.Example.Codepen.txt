...
class ContextualMenuWithCustomMenuListExample extends React.Component<
  {},
  {
...
ReactDOM.render(<ContextualMenuWithCustomMenuListExample />, document.getElementById('content'));
